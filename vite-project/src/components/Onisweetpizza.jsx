...
import image1 from '../assets/images/onisweetpizza.jpg'
import { href, Link } from 'react-router-dom'


export default function Onisweetpizza() {


    let data = [
        { href: '/onisweetchepizza' , href2:"/onisweetfinal" }
    ]
    return (
        <div className=' flex justify-center bg-cyan-200'>
            <div className=' border-2 border-red-600 h-100 w-70 bg-red-500'>
                ...
                <h1 className=' text-2xl text-center py-2'>Add Cheeze ?</h1>
                <div className='py-5 flex p-2 gap-2 text-yellow-300'>
                    {
                     ...
                     {
                        data.map((item, key) => (
                            <Link to={item.href2}><h1 className='bg-blue-500 hover:bg-blue-700 border-2 border-black h-10 w-30 text-2xl items-center text-center'>no</h1></Link>
